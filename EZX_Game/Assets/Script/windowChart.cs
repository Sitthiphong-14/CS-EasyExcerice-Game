...
{
    [Header("title text")]
    [SerializeField] private TMP_Text timeTotal;
    [SerializeField] private TMP_Text kcalTotal;
    ...
    public void renderGraph()
    {
        ...
        StartCoroutine(ApiCall.getRecord(ApiManager.Instance.user.access_token, () =>
        {
            ...
            timeTotal.text = ApiManager.Instance.activitiesList.time / 60 + "mins";
            kcalTotal.text = ApiManager.Instance.activitiesList.burned_cal + "Kcal";
        }, () =>
        {
            Debug.LogError("create chart fail");
        }));
    }
